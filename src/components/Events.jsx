        ...
        <div className="max-w-[768px] mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex p-4 rounded-[30px] border-lightgray border bg-white mb-5 max-sm:mb-3 relative">
              <input className="w-full outline-none text-sm font-bold placeholder:text-gray text-gray" type="text" name="category" placeholder="Kategorie" value={formData.category} onChange={handleChange} />
              ...
              {isDropdownOpen && (
                <div className="absolute bg-white border border-gray-300 rounded-[10px] mt-2 w-full z-10 right-0">
                  <ul>
                    ...
                    <li className="p-2 cursor-pointer text-sm font-bold text-gray" onClick={() => handleOptionSelect('Movies')} > Movies</li>
                  </ul>
                </div>)}
            </div>
            <div className="sm:flex gap-5 mb-5 max-sm:mb-3">
              <input className="py-[17.5px] pl-4 max-sm:w-full max-sm:mb-3 placeholder:text-gray text-gray  rounded-[30px] border-lightgray border outline-none text-sm font-bold w-[50%]"
                type="text" required name="title" placeholder="Titel" value={formData.title} onChange={handleChange} />
              <input className="py-[17.5px] pl-4 max-sm:w-full rounded-[30px] placeholder:text-gray text-gray border-lightgray border outline-none text-sm font-bold w-[50%]"
            ...
            <div className="sm:flex gap-5 pb-5 max-sm:pb-3">
              <input className="py-[17.5px] pl-4 max-sm:w-full max-sm:mb-3 rounded-[30px] placeholder:text-gray text-gray border-lightgray border outline-none text-sm font-bold w-[50%]"
            ...
            <textarea
              className="w-full py-[55.5px] max-sm:pt-10 max-sm:pb-5 mb-5 leading-6 placeholder:text-gray text-gray text-sm font-bold resize-none outline-none pl-4 rounded-[30px] border-lightgray border text-gray"
