        ...
        <div className="max-w-[768px] mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex p-4 rounded-[30px] border-lightgray border bg-white mb-5 relative">
              ...
              {isDropdownOpen && (
                <div className="absolute bg-white border border-gray-300 rounded-[10px] mt-2 w-[150px] z-10 right-[4%] top-[4%]">
                  <ul>
                    <li
                      className="p-2 cursor-pointer text-sm font-bold"
            ...
            <div className="flex gap-5 mb-5">
              <input
                className="py-[17.5px] pl-4 max-sm:py-3 rounded-[30px] border-lightgray border outline-none text-sm font-bold w-[50%]"
                type="text"
                required
                name="title"
                placeholder="Titel"
            ...
            <div className="flex gap-5 pb-5">
              ...
              />
              <input
                className="py-[17.5px] max-sm:py-3 pl-4 rounded-[30px] border-lightgray border outline-none text-sm font-bold w-[50%]"
                type="text"
                required
                name="price"
                placeholder="Preis"
